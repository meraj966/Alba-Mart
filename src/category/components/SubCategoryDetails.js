    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                if (categoryDoc.exists()) {
                    const subCategoryMap = categoryDoc.data().subCategory || {};
                    const subcategories = Object.keys(subCategoryMap).map((key) => {
                        const subcategoryData = subCategoryMap[key];
                        return {
                            subcategoryName: subcategoryData.subcategoryName,
                            imageUrl: subcategoryData.imageUrl, // Assuming this is the correct field name.
                        };
                    });
                    setSubcategoryData(subcategories);
                }
