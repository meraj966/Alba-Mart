...
export const pageToAccessKeyMapping = {
  ...
  [URLS.VARIANT_DETAILS_URL]: "VIEW_VARIANT_DETAILS",
  [URLS.FAQ_URL]: "VIEW_FAQ",
  [URLS.VARIANT_URL]: "VIEW_VARIANT",
  [URLS.ORDERS_URL]: "VIEW_ORDERS",
  [URLS.ORDER_PREVIEW_URL]: "VIEW_ORDERS", 
  ...
  [URLS.DELIVERY_BOY_DETAILS_URL]: "VIEW_DELIVERY_BOY_DETAILS",
  [URLS.OFFER_SETTINGS_URL]: "VIEW_OFFER_SETTINGS",
  [URLS.OFFER_DETAILS_URL]: "VIEW_OFFER_DETAILS",
  [URLS.EDIT_OFFER_DETAILS_URL]: "EDIT_OFFER_DETAILS",
...
export const CONTROL_ADD_TERMS_AND_CONDITIONS = "ADD_TERMS_AND_CONDITIONS"
...
export const CONTROL_EDIT_NOTIFICATIONS = "EDIT_NOTIFICATIONS";
export const CONTROL_DELETE_NOTIFICATIONS = "DELETE_NOTIFICATIONS";
...
export const CONTROL_EDIT_CONTACT_DETAILS = "EDIT_CONTACT_DETAILS";
export const CONTROL_DELETE_CONTACT_DETAILS = "DELETE_CONTACT_DETAILS";
export const CONTROL_ADD_VARIANT = "ADD_VARIANT";
export const CONTROL_EDIT_VARIANT = "EDIT_VARIANT";
export const CONTROL_DELETE_VARIANT = "DELETE_VARIANT";
